...
export default function DistributorList() {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          // "https://ipaisa.co.in/api/auth/adminds",
          // "http://api.ipaisa.site/api/protected/underme/Distributor",
          "https://ipaisa.co.in/api/protected/underme/Distributor",
  ...
  const handleDelete = async (itemId: any) => {
    try {
      ...
      await axios.delete(
        // `https://ipaisa.co.in/api/delete/superdistributor/${itemId}`,
  ...
  const handleEdit = async (itemId: any) => {
    try {
      ...
      await axios.put(
        `https://ipaisa.co.in/api/update/channelpartner/${itemId}`,
        {
          headers: headers,
        }
      );
