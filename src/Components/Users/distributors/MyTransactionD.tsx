...
// export default function MyTransactionD() {
//   return <div>MyTransactionD</div>;
// }
...
//         // apiUrl = `https://ipaisa.co.in/api/ftrans?startDate=${fromDate}&endDate=${toDate}`;
//         apiUrl = `https://ipaisa.co.in/api/protected/adminalltransactions`;
...
export default function MyTransactionCp() {
  ...
  const handleSearch = async () => {
    try {
      ...
      if (transactionType === "wallet") {
        // apiUrl = `https://ipaisa.co.in/api/ftrans?startDate=${fromDate}&endDate=${toDate}`;
        apiUrl = `https://ipaisa.co.in/api/protected/my-transactions`;
      } else if (transactionType === "transactions") {
        // apiUrl = `https://ipaisa.co.in/api/protected/adminalltransactions`;
      }
